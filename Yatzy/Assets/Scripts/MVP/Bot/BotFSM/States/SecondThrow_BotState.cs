...
public class SecondThrow_BotState : IBotState
{
    ...
    public SecondThrow_BotState(IDiceRollProvider diceRollProvider, IYatzyCombinationsProvider yatzyCombinationsProvider)
    {
    ...
    public void EnterState()
    {
        ...
        Debug.Log("АКТИВАЦИЯ СОСТОЯНИЯ ВТОРОГО БРОСКА");
